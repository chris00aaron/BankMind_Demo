...
@Repository
public interface JpaSelfTrainingAuditWithdrawalModelRepository 
    extends JpaRepository<SelfTrainingAuditWithdrawalModel, Long>, JpaSpecificationExecutor<SelfTrainingAuditWithdrawalModel> {
