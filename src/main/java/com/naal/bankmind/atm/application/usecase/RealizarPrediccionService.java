...
@AllArgsConstructor
@Service
public class RealizarPrediccionService implements RealizarPrediccionUseCase {
    ...
    @Override
    public List<OutputDataPredictionRetiroAtm> generarPrediccion(List<InputDataPredictionRetiroAtm> inputData) {
        return withdrawalPredictionService.predecirWithdrawalHistoric(inputData);
    }
}
